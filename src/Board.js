...
export default class Board extends React.Component {
  ...
  handleDrag() {
    new Dragula([...document.querySelectorAll(".Swimlane-dragColumn")], {
      isContainer: (el) => false,
      // direction: "vertical",
    }).on("drop", (el, target, source, sibling) => {
      let siblingStatus = sibling.getAttribute("data-status");
      if (siblingStatus === "backlog") {
        console.log("helloasdf");
        el.className = "Card Card-grey";
      } else if (siblingStatus === "in-progress") {
        el.className = "Card Card-blue";
      } else if (siblingStatus === "complete") {
